...
/* resources*/
insert into resources(resource_type_id,resource_name,resource_path) values(2,'ACL_STORAGE','/home/Gauri/ACL');

insert into user_group (id,user_id) values(1,1);

insert into user_permission (resource_id,id,permission_id) values(1,1,111);

insert into group_permission (resource_id,id,permission_id) values(1,1,111);
